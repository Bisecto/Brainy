...
public class English2015Questions extends AppCompatActivity {

   //MyQuestionDatabase myQuestionDatabase;
MyDataBase myDataBase;
    LinearLayout container,Delete_Edit;
    LayoutInflater layoutInflater;
    int id;
    Cursor res;
    TextView popQuestion, popOption1,popOption2, popOption3,popOption4,popAnswer,Remove,Edit,subject,Admin_Board;
...
Button Input;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admin_Board.setText("En215Q");
        myDataBase=new MyDataBase(this);
        layoutInflater = LayoutInflater.from(this);
        container= findViewById(R.id.container);
        res = myDataBase.ReadEn2015Question();
        ...
        //popQuestion, popOption1,popOption2, popOption3,popOption4,popAnswer,Remove,Edit;
        ...
        while (res.moveToNext()) {
            ...
            Delete_Edit = view.findViewById(R.id.Delete_Edit);
...
//                Toast.makeText(English2015Questions.this, "Hmmmmmm", Toast.LENGTH_SHORT).show();
//            }
//        });
        Input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myDataBase= new MyDataBase(English2015Questions.this);
                                ...
                                if (!Op4.trim().equals("")){
                                    if (!Ans.trim().equals("")){
                                        if (Ans.equals(Op1)||Ans.equals(Op2)|| Ans.equals(Op3) ||Ans.equals(Op4)){
                                            ...
                                            if (isInserted == true) {
                                                //Log.i("my","correct");
                                                Toast.makeText(English2015Questions.this, "Question Sucessfully Added", Toast.LENGTH_LONG).show();
                                                Intent i = new Intent(English2015Questions.this, English2015Questions.class);
                                                finish();
                                                overridePendingTransition(0,0);
                                                startActivity(i);
                                                overridePendingTransition(0,0);
                                            } else{
                                                Toast.makeText(English2015Questions.this, "Not Sucessful", Toast.LENGTH_LONG).show();
                                            }
                                        } else {
