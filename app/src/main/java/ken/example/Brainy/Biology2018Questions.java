...
public class Biology2018Questions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admin_Board.setText("Bio218Q");

        myDataBase=new MyDataBase(this);
        layoutInflater = LayoutInflater.from(this);
        container= findViewById(R.id.container);
        res = myDataBase.ReadBio2018Question();
        ...
        Input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myDataBase= new MyDataBase(Biology2018Questions.this);
                                ...
                                if (!Op4.trim().equals("")){
                                    if (!Ans.trim().equals("")){
                                        if (Ans.equals(Op1)||Ans.equals(Op2)|| Ans.equals(Op3) ||Ans.equals(Op4)){
                                            ...
                                            if (isInserted == true) {
                                                //Log.i("my","correct");
                                                Toast.makeText(Biology2018Questions.this, "Question Sucessfully Added", Toast.LENGTH_LONG).show();
                                                Intent i = new Intent(Biology2018Questions.this, Biology2018Questions.class);
                                                finish();
                                                overridePendingTransition(0,0);
                                                startActivity(i);
                                                overridePendingTransition(0,0);
                                            } else{
                                                Toast.makeText(Biology2018Questions.this, "Not Sucessful", Toast.LENGTH_LONG).show();
                                            }
                                        } else {
