...
public class English2020Questions extends AppCompatActivity {
...
MyDataBase myDataBase;
    ...
    int id;
    Cursor res;
    TextView popQuestion, popOption1,popOption2, popOption3,popOption4,popAnswer,Admin_Board,subject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admin_Board.setText("En220Q");

        myDataBase=new MyDataBase(this);
        layoutInflater = LayoutInflater.from(this);
        container= findViewById(R.id.container);
        res = myDataBase.ReadEn2020Question();
        ...
        Input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myDataBase= new MyDataBase(English2020Questions.this);
                                ...
                                if (!Op4.trim().equals("")){
                                    if (!Ans.trim().equals("")){
                                        if (Ans.equals(Op1)||Ans.equals(Op2)|| Ans.equals(Op3) ||Ans.equals(Op4)){
                                            ...
                                            if (isInserted == true) {
                                                //Log.i("my","correct");
                                                Toast.makeText(English2020Questions.this, "Question Sucessfully Added", Toast.LENGTH_LONG).show();
                                                Intent i = new Intent(English2020Questions.this, English2020Questions.class);
                                                finish();
                                                overridePendingTransition(0,0);
                                                startActivity(i);
                                                overridePendingTransition(0,0);
                                            } else{
                                                Toast.makeText(English2020Questions.this, "Not Sucessful", Toast.LENGTH_LONG).show();
                                            }
                                        } else {
