...
public class Physics2018Questions extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Admin_Board.setText("Phy218Q");
        myDataBase=new MyDataBase(this);
        layoutInflater = LayoutInflater.from(this);
        container= findViewById(R.id.container);
        res = myDataBase.ReadPhy2018Question();
        ...
        Input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myDataBase= new MyDataBase(Physics2018Questions.this);
                                ...
                                if (!Op4.trim().equals("")){
                                    if (!Ans.trim().equals("")){
                                        if (Ans.equals(Op1)||Ans.equals(Op2)|| Ans.equals(Op3) ||Ans.equals(Op4)){
                                            ...
                                            if (isInserted == true) {
                                                //Log.i("my","correct");
                                                Toast.makeText(Physics2018Questions.this, "Question Sucessfully Added", Toast.LENGTH_LONG).show();
                                                Intent i = new Intent(Physics2018Questions.this, Physics2018Questions.class);
                                                finish();
                                                overridePendingTransition(0,0);
                                                startActivity(i);
                                                overridePendingTransition(0,0);
                                            } else{
                                                Toast.makeText(Physics2018Questions.this, "Not Sucessful", Toast.LENGTH_LONG).show();
                                            }
                                        } else {
