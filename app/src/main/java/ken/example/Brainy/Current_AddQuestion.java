...
public class Current_AddQuestion extends AppCompatActivity {
    ...
    int id;
    Cursor res;
    TextView popQuestion, popOption1,popOption2, popOption3,popOption4,popAnswer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView Admin_Board=findViewById(R.id.Admin_Board);
        Admin_Board.setText("Add Current Affair Questions");

        myQuestionDatabase=new MyQuestionDatabase(this);
        layoutInflater = LayoutInflater.from(this);
        container= findViewById(R.id.container);
        res = myQuestionDatabase.ReadCurrentData();
        ...
        Input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myQuestionDatabase= new MyQuestionDatabase(Current_AddQuestion.this);
                                ...
                                if (!Op4.trim().equals("")){
                                    if (!Ans.trim().equals("")){
                                        if (Ans.equals(Op1)||Ans.equals(Op2)|| Ans.equals(Op3) ||Ans.equals(Op4)){
                                            isInserted = myQuestionDatabase.Insert_Current(Question, Op1, Op2, Op3, Op4,Ans);
                                            if (isInserted == true) {
                                                //Log.i("my","correct");
                                                Toast.makeText(Current_AddQuestion.this, "Question Sucessfully Added", Toast.LENGTH_LONG).show();
                                                Intent i = new Intent(Current_AddQuestion.this, Current_AddQuestion.class);
                                                finish();
                                                overridePendingTransition(0,0);
                                                startActivity(i);
                                                overridePendingTransition(0,0);
                                            } else{
                                                Toast.makeText(Current_AddQuestion.this, "Not Sucessful", Toast.LENGTH_LONG).show();
                                            }
                                        } else {
